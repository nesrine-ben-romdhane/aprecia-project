...
import { faBell, faMessages } from "@fortawesome/free-solid-svg-icons";
...
const AdminNavbar = props => {
  ...
  if(localStorage.getItem("ResponsableInfo"))
  {
   ...
   Fname=JSON.parse(localStorage.getItem("ResponsableInfo")).nom;
    ...
    imageR=JSON.parse(localStorage.getItem("ResponsableInfo")).image;
    ...
    imageR=JSON.parse(localStorage.getItem("employeeInfo")).image;
  }
                    ...
                    <Form className="navbar-search navbar-search form-inline ">
                        <FormGroup  >
                            <InputGroup className="input-group-alternative" >
                                ...
                                <Input placeholder="Search" type="text" className="pt-3 " style={ {height:"20px",width:"250px"}} />
                            </InputGroup>
                        </FormGroup>
                    </Form>
